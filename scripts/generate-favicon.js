...
// Simplified favicon SVG component
const FaviconSVG = () => (
  <svg
    width="32"
    height="32"
...
const svgString = renderToString(React.createElement(FaviconSVG))
...
fs.writeFileSync(faviconPath, svgString)

console.log('Favicon SVG generated successfully at:', faviconPath)
