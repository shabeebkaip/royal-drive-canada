...
import { Brand, VehicleType, FuelType } from '@/types/api'

interface MegaMenuBarClientProps {
    initialBrands: Brand[]
    initialBodyTypes: VehicleType[]
    initialFuelTypes: FuelType[]
}

const MegaMenuBarClient = ({ initialBrands, initialBodyTypes, initialFuelTypes }: MegaMenuBarClientProps) => {
    const [activeMegaMenu, setActiveMegaMenu] = useState<string | null>(null)
    const brands = initialBrands
    const bodyTypes = initialBodyTypes
    const fuelTypes = initialFuelTypes
    const router = useRouter()

    // Data is now passed as props from server component - no client-side fetching needed!
...
export default MegaMenuBarClient
