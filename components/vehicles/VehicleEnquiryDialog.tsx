...
export default function VehicleEnquiryDialog({
  vehicle,
  trigger,
}: VehicleEnquiryDialogProps) {
      ...
      const payload = {
        ...
        enquiry: {
          ...
          preferredTime: formData.preferredTime
            ? timeSlotMap[formData.preferredTime] || formData.preferredTime
            : undefined,
        },
        interests: {
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription className="text-base">
            {`Interested in this ${vehicle.year} ${vehicle.make.name} ${vehicle.model.name}? Fill out the form below and we'll get back to you shortly.`}
          </DialogDescription>
        </DialogHeader>
