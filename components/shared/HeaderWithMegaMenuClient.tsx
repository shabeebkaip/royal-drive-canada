...
const HeaderWithMegaMenuClient = ({ showMegaMenu = false, initialBrands = [] }: MegaMenuProps) => {
    ...
    // Brands now passed as props from server component - no client-side fetching needed!
...
export default HeaderWithMegaMenuClient
