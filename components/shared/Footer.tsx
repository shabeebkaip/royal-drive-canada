...
const Footer = async () => {
  ...
  // Fetch business settings server-side with 5-minute cache
  const settings: BusinessSettings = await getPublicSettings({ revalidate: 300 });
  ...
  const businessName = settings.businessName || 'Royal Drive';
  const description = settings.description || "Toronto's premier destination for quality pre-owned vehicles. We deliver exceptional quality, safety-certified cars with unmatched customer service.";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-4 space-y-6">
              ...
              <div className="space-y-3">
                <a href={`tel:${phone.replace(/[^0-9+]/g, '')}`} className="flex items-center gap-3 hover:opacity-80 transition-opacity">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-sm">
                      {settings.businessHours?.[0]?.isOpen ? 'See hours below' : 'Mon-Sat, 9AM-7PM'}
                    </p>
                  </div>
                </a>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-5">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4 text-gray-500">
                <p className="text-sm">© {currentYear} {businessName}. All rights reserved.</p>
