...
import { Search, Filter, LayoutGrid, List, SlidersHorizontal, Car, DollarSign } from 'lucide-react'
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        {filteredVehicles.length > 0 ? (
          <div className={isHorizontal ? 'space-y-6' : 'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'}>
      ...
      <section className="bg-gray-50 py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button className="px-8 py-3 bg-white hover:bg-gray-50 text-blue-600 font-semibold rounded-lg border border-blue-600 transition-colors">
